...
class SG_View_Helper_FormDate extends Zend_View_Helper_FormElement
{
     ...
     */
    public function formDate($name, $value = null, $attribs = null, array $options = null)
    {
        ...
        $dateScript = '<script>'
            . '$(function() {'
            . ' $( "#' . $this->view->escape($id) . '" ).datepicker({changeMonth: true,changeYear: true,dateFormat:"yy-mm-dd"});'
            . '});'
            . '</script>';
