 ...
 * @copyright  Copyright (c) 2013 Agustinus Prasetyo (agustinus.widodo@gmail.com)
 */
class SG_View_Helper_FormRadio extends Zend_View_Helper_FormElement
{
    /**
     * Input type to use
     * @var string
        ...
        $options = null, $listsep = "<br />\n")
    {
        ...
        $optionSize = sizeof($options);
        $i = 0;
        // add radio buttons to the list.
        foreach ($options as $opt_value => $opt_label) {
            $styleFloatLeft = '';
            if (($i + 1) != $optionSize)
                $styleFloatLeft = ' style="float: left; display: inline; width: 90px;"';
            ...
            $radio = '<label'
                    . $styleFloatLeft
                    . $this->_htmlAttribs($label_attribs) . ' for="' . $optId . '" class="radio" style="margin-bottom: 15px;">'
